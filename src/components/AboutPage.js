  ...
  return (
    <div className='about-page'>
      ...
      <div className='dispersed-ps'>
        <p>Dispersed is a web app designed to help camping enthusiasts find new locations to go dispersed camping. Dispersed camping is allowed on most forest service roads open to public use, but mapping options are less than ideal. Generally the only way to explore dispersed camping locations is on a large paper map from the forest service, which is difficult to later locate with gps mapping.</p>
        <p>With Dispersed, you can now find available areas on an interactive map, with color-coded road information. You can also get current weather information along with a 5 day forecast, and can save spots you'd like to visit later.</p>
      </div>
